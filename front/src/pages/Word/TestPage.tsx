...
const TestPage: React.FC<TestPageProps> = ({ selectedCategory, setShowResultPage }) => {
  ...
  return (
    <Box minH="555px" background="white" borderWidth={1} borderRadius="lg" p={4} alignItems="center" justifyContent="center">
      <Text fontSize="xl" fontWeight="bold" >
        ✏️단어학습 ({selectedCategory.toUpperCase()})
      </Text>
      <Flex minH="438px" margin="16px 0" direction="column" alignItems="center" justifyContent="center">
        <Box>
