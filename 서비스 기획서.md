...
이름 후보
"VocaBreeze" : 단어를 '쉽게' 학습할 수 있다는 개념을 전달합니다.
"WordWing" : 단어가 마치 날개처럼 지식을 확장시킨다는 메타포입니다.
"LexiLearn" : Lexi는 '단어'를 의미하는 Lexicon에서 유래하였고, Learn은 '학습'이라는 의미입니다.
"VocabVenture" : 단어 학습이 마치 모험처럼 새로운 것들을 발견하는 경험이라는 메시지를 전달합니다.
"MemorEase" : Memorize와 Ease의 조합으로, 쉽게 기억하자는 의미입니다.
